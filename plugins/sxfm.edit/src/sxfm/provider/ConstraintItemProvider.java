...
/**
 * This is the item provider adapter for a {@link sxfm.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SxfmPackage.Literals.CONSTRAINT__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SxfmPackage.Literals.CONSTRAINT__OR);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Constraint_type") + " " + constraint.getId();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Constraint.class)) {
			case SxfmPackage.CONSTRAINT__ID:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SxfmPackage.CONSTRAINT__OR:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SxfmPackage.Literals.CONSTRAINT__OR,
				 SxfmFactory.eINSTANCE.createOr()));
	}
