 ...
 * <ul>
 *   <li>{@link sxfm.impl.ContainerElementImpl#getChildrenFeatures <em>Children Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class ContainerElementImpl extends EObjectImpl implements ContainerElement {
	/**
	...
	protected EClass eStaticClass() {
		return SxfmPackage.Literals.CONTAINER_ELEMENT;
	}
	...
	public EList<ContainableElement> getChildrenFeatures() {
		if (childrenFeatures == null) {
			childrenFeatures = new EObjectContainmentEList<ContainableElement>(ContainableElement.class, this, SxfmPackage.CONTAINER_ELEMENT__CHILDREN_FEATURES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SxfmPackage.CONTAINER_ELEMENT__CHILDREN_FEATURES:
