 ...
 * <ul>
 *   <li>{@link sxfm.impl.OptionalImpl#getChildrenFeatures <em>Children Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OptionalImpl extends FeatureImpl implements Optional {
	/**
	...
	protected EClass eStaticClass() {
		return SxfmPackage.Literals.OPTIONAL;
	}
	...
	public EList<ContainableElement> getChildrenFeatures() {
		if (childrenFeatures == null) {
			childrenFeatures = new EObjectContainmentEList<ContainableElement>(ContainableElement.class, this, SxfmPackage.OPTIONAL__CHILDREN_FEATURES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SxfmPackage.OPTIONAL__CHILDREN_FEATURES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ContainerElement.class) {
			switch (derivedFeatureID) {
				case SxfmPackage.OPTIONAL__CHILDREN_FEATURES: return SxfmPackage.CONTAINER_ELEMENT__CHILDREN_FEATURES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ContainerElement.class) {
			switch (baseFeatureID) {
				case SxfmPackage.CONTAINER_ELEMENT__CHILDREN_FEATURES: return SxfmPackage.OPTIONAL__CHILDREN_FEATURES;
				default: return -1;
			}
		}
		if (baseClass == ContainableElement.class) {
