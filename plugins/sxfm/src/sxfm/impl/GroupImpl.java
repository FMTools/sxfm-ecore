 ...
 * <ul>
 *   <li>{@link sxfm.impl.GroupImpl#getGroupedFeatures <em>Grouped Features</em>}</li>
 *   <li>{@link sxfm.impl.GroupImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GroupImpl extends CardinalizedElementImpl implements Group {
	/**
	...
	protected EClass eStaticClass() {
		return SxfmPackage.Literals.GROUP;
	}
	...
	public EList<GroupedFeature> getGroupedFeatures() {
		if (groupedFeatures == null) {
			groupedFeatures = new EObjectContainmentEList<GroupedFeature>(GroupedFeature.class, this, SxfmPackage.GROUP__GROUPED_FEATURES);
		}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SxfmPackage.GROUP__ID, oldId, id));
	}
